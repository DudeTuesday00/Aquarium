...
1. Choose your tank goal and layout style.  
2. Place the main hardscape piece first.  
3. Decide where negative space will live.  
4. Add supporting hardscape.  
5. Plant in groups and layers.  
6. Step back, remove extras, and fine-tune.
...
Or read the [Aquarium Lighting Guide](/guides/aquarium-lighting-guide) and [Low-Maintenance Planted Tank Guide](/guides/setting-up-a-low-maintenance-planted-aquarium) next.
