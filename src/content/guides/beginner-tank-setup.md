...
description: A complete step-by-step beginner aquarium setup guide covering tank size, equipment, cycling, stocking, and the most common mistakes that ruin first tanks.
...
1. Fill the aquarium with water carefully so the substrate does not get blasted around.
2. Add water conditioner to remove chlorine or chloramine.
3. Start the filter.
4. Start the heater if the setup needs one.
5. Check that the tank reaches the target temperature.
6. Turn on the light and make sure everything runs correctly.
